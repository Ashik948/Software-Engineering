 ...
 * @author Mahmud
 */
public class OrdersAdmin extends javax.swing.JFrame {
    ...
    OrdersAdmin(String string, int aInt) {
...
//        GetOrderID();
    ...
    OrdersAdmin(String seller_admin) {
        initComponents();
...
//        GetOrderID();
        ...
        usershow.setText("Seller: " + seller_admin);

        globalseller = seller_admin;
...
//        GetOrderID();
    ...
    private void initComponents() {
        ...
        Home_Level = new javax.swing.JLabel();
        ...
        Home_Level.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Home2.png"))); // NOI18N
        Home_Level.setToolTipText("Home");
        Home_Level.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Home_Level.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Home_LevelMouseClicked(evt);
            }
        });
        jPanel2.add(Home_Level, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 100, -1, -1));
...
//    }
    ...
    private void Home_LevelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Home_LevelMouseClicked
        new Home().setVisible(true);
        dispose();
    }//GEN-LAST:event_Home_LevelMouseClicked
    ...
    private javax.swing.JLabel Home_Level;
