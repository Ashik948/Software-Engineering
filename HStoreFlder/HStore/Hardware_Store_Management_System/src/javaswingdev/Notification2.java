...
public class Notification2 extends javax.swing.JComponent {
    ...
    private int animate = 65;
    private BufferedImage imageShadow;
    private int shadowSize = 1;
    private Type type;
    private Location location;
    
    public Notification2(Frame fram, Type type, Location location, String message) {
        this.fram = fram;
        this.type = type;
    ...
    private void init(String message) {
        setBackground(new Color(31,54,77));
    ...
    private BufferedImage createShadow() {
        ...
        g2.dispose();
        return new ShadowRenderer2(shadowSize, 0.3f, new Color(100, 100, 100)).createShadow(img);
    }
    ...
    private void initComponents() {
        ...
        add(lbIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, -1, 67));

        panel.setBackground(new java.awt.Color(255, 0, 204));
        panel.setOpaque(false);

        lbMessage.setFont(new java.awt.Font("Trajan Pro", 1, 16)); // NOI18N
        lbMessage.setForeground(new java.awt.Color(255, 255, 255));
        lbMessage.setText("Message");

        lbMessageText.setFont(new java.awt.Font("Trajan Pro", 1, 12)); // NOI18N
        lbMessageText.setForeground(new java.awt.Color(255, 255, 255));
        ...
        panelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelLayout.createSequentialGroup()
                ...
                .addComponent(cmdClose, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE))
        );

        add(panel, new org.netbeans.lib.awtextra.AbsoluteConstraints(54, 10, 230, -1));
